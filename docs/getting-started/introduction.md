...
[Laravel PayHere](https://github.com/laravel-payhere/laravel-payhere) is a third-party payment gateway plugin for Laravel. It lets you easily integrate [PayHere](https://payhere.lk) into your Laravel application, supporting all PayHere APIs to handle different types of payments.
